    ...
    <Hero />
      <div className="home-container">
        <div>
          ...
          department of GIKIHUBS GROUP. This exciting partnership aims to open
          up new avenues for technological expertise within our organization. we
          always recognize the importance of incorporating new technology into
          our operations for enhanced efficiency and service delivery.
          Application Period: The application window will be open from the 11TH
          of March 2024 to the 30th of March 2024. Please submit your
          application within this timeframe. To apply, carefully review the role
          descriptions and ensure eligibility. Submit your application through
          the provided online form, including a comprehensive resume/CV and any
          required documents. We value diversity and equal opportunity,
          encouraging candidates from all backgrounds to apply. All information
          shared will be treated confidentially. After you submit your
          application, our dedicated recruitment team will thoroughly review all
          applications and return correspondences through your email address we
          have in our file. We look forward to receiving your applications.
          Should you have any further inquiries or require additional
          information, please reach out to our HR department. through email at
          sales@richforthstore.com
        </div>
          ...
          <p>- Keeping up with emerging technologies and industry trends.</p>
            ...
            <div>
              ...
              {open && (
                <div className="viewContent">
                  ...
                  <p>
                    {" "}
                    - Managing databases, server-side logic, and user
                    interfaces.
                  </p>
                  <p>
                  ...
                  <p>
                    - Ensuring seamless integration and smooth functionality of
            ...
            <div>
              ...
              {openFrontend && (
                <div className="viewContent">
                  <p>
                    {" "}
                    - Implementing user interfaces using HTML, CSS, and
                    JavaScript.
                  </p>
                  <p>
                    {" "}
                    - Collaborating with designers to translate visual designs
                    into functional web pages or applications.
                  </p>
                  <p>
                    {" "}
                    - Optimizing web pages for performance and responsiveness.
                  </p>
                  <p>
                    {" "}
            ...
            <div>
              ...
              {openBackend && (
                <div className="viewContent">
                  <p>
                    - Developing server-side logic and APIs to support web or
                    mobile applications.
                  </p>
                  ...
                  <p>
                    {" "}
                    - Conducting testing and debugging of server-side
                    applications.
                  </p>
                  <p>
                    - 5+ years of experience in web development, with a strong
                  ...
                  <p>
                    {" "}
                    - Solid understanding of server-side programming languages,
                    such as PHP, Python, or Java, and experience with RESTful
            ...
            <div>
              ...
              {openUI && (
                <div className="viewContent">
                  ...
                  <p>
                    {" "}
                    - Creating wireframes, prototypes, and mockups to
                  ...
                  <p>
                    {" "}
                    - Conducting usability testing and incorporating user
            ...
            <div>
              ...
              {openDatascience && (
                <div className="viewContent">
                  <p>
                    - Analyzing complex data sets to identify patterns, trends,
                    and insights.
                  </p>
                  <p>
                  ...
                  <p>
                    {" "}
                    - Collaborating with stakeholders to define data
            ...
            <div>
              <div className="content">
                <h5 className="job-title">
                  DevOps Engineer & Project Managers:
                </h5>
                {!openDevOps ? (
              ...
              {openDevOps && (
                <div className="viewContent">
                  <p>
                    - Automating and streamlining software development
                    processes.
                  </p>
                  <p>
                    - Managing and configuring infrastructure, servers, and
                    cloud services.
                  </p>
                  <p>
                  ...
                  <p>
                    - Monitoring system performance and ensuring high
                    availability.
                  </p>
                  <p>
